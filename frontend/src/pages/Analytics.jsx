      ...
      >
        <main className="p-4 md:p-6 lg:p-8">
            ...
            {[
              {
                ...
                color: "from-[#00bea3] to-[#00bea3]/80",
              ...
              },
              {
                ...
                color: "from-[#28A745] to-[#28A745]/80",
              ...
              },
              {
                ...
                color: "from-[#FFC107] to-[#FFC107]/80",
              ...
              },
              {
                ...
                color: "from-[#ff6d34] to-[#ff6d34]/80",
              ...
              <div
                key={idx}
                className="group relative bg-white dark:bg-[#2D3436] rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
              >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <div className="bg-white dark:bg-[#2D3436] rounded-xl p-4 shadow-sm">
          ...
          {activeTab === "courses" && (
            <div className="mb-8">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-[#2D3436] dark:text-gray-200 flex items-center gap-2">
                  <BookOpen className="w-6 h-6 text-[#00bea3]" />
                  My Courses
                  <span className="text-sm font-normal text-[#2D3436]/60 bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded-full">
              ...
              <div className="bg-white dark:bg-[#2D3436] rounded-2xl shadow-lg overflow-hidden border border-[#CCCCCC]/30 dark:border-gray-700">
                <div className="overflow-x-auto">
                  <table className="w-full text-left">
                    <thead className="bg-[#F5F5F5] dark:bg-gray-700/50">
                      <tr>
                        <th className="px-6 py-4 text-xs font-semibold text-[#2D3436]/70 uppercase tracking-wider">Course</th>
                        <th className="px-6 py-4 text-xs font-semibold text-[#2D3436]/70 uppercase tracking-wider">Progress</th>
                        <th className="px-6 py-4 text-xs font-semibold text-[#2D3436]/70 uppercase tracking-wider">Stats</th>
                        <th className="px-6 py-4 text-xs font-semibold text-[#2D3436]/70 uppercase tracking-wider">Level</th>
                        <th className="px-6 py-4 text-xs font-semibold text-[#2D3436]/70 uppercase tracking-wider">Action</th>
                      </tr>
                    </thead>
                          ...
                          >
                            <td className="px-6 py-4">
                              <Link to={`/learning/${course.id}`} className="flex items-center gap-4">
                                ...
                                <div>
                                  <div className="font-semibold text-[#2D3436] dark:text-gray-200 line-clamp-1">
                                    {course.title}
                                  </div>
                                  <div className="flex items-center gap-2 mt-1">
                                    <span className="text-xs px-2 py-0.5 bg-gray-100 dark:bg-gray-700 rounded-full text-[#2D3436]/70 dark:text-gray-300">
                                      {course.category}
                                    </span>
                                    <span className="text-xs text-[#2D3436]/50 dark:text-gray-400">
                            ...
                            <td className="px-6 py-4">
                              <div className="flex items-center gap-1">
                                ...
                                <span className="text-sm text-[#2D3436]/70 dark:text-gray-400">
          ...
          {activeTab === "calendar" && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* CALENDAR */}
              <div className="lg:col-span-2 bg-white dark:bg-[#2D3436] rounded-2xl p-6 shadow-lg">
                {/* Month Navigation */}
                <div className="flex justify-between items-center mb-6">
                  ...
                  <span className="text-xl font-bold text-[#2D3436] dark:text-gray-200">
                      ...
                      <div
                        ...
                        className={`relative h-24 rounded-xl p-2 cursor-pointer transition-all duration-300
                          ${selectedDate === key 
                            ...
                            : 'hover:ring-1 hover:ring-[#CCCCCC] dark:hover:ring-gray-600'
                          }
                          ${isToday 
                            ? 'bg-gradient-to-br from-orange-50 to-yellow-50 dark:from-[#ff6d34]/20 dark:to-[#FFC107]/20 border-2 border-[#ff6d34]' 
                            : taskList.length > 0 && completedCount === taskList.length
                            ? 'bg-gradient-to-br from-green-50 to-emerald-50 dark:from-[#28A745]/20 dark:to-[#28A745]/20'
                            : 'bg-white dark:bg-gray-800'
                          }`}
                      >
                        <div className="flex justify-between items-start">
                          <span className={`text-sm font-semibold ${
                            isToday ? 'text-[#ff6d34] dark:text-[#ff6d34]' : 'text-[#2D3436] dark:text-gray-300'
                          }`}>
                            {day}
                          </span>
                          {taskList.length > 0 && (
                ...
                <div className="flex flex-wrap items-center gap-4 mt-6 pt-4 border-t border-[#CCCCCC] dark:border-gray-700">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-[#2D3436]/70 dark:text-gray-400">All Completed</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span>✅</span>
              ...
              {/* TASK PANEL */}
              <div className="bg-white dark:bg-[#2D3436] rounded-2xl p-6 shadow-lg">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-bold text-[#2D3436] dark:text-gray-200 flex items-center gap-2">
                ...
                <div className="flex gap-2 mb-6">
                  <input
                    ...
                    className="w-[65%] border border-[#CCCCCC] dark:border-gray-700 dark:bg-gray-900 dark:text-white p-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#ff6d34] transition"
                    placeholder="Add a new task..."
                  />

                  <button
                    onClick={addTask}
                    className="w-[35%] bg-[#ff6d34] hover:bg-[#ff6d34]/90 text-white px-4 rounded-xl transition flex items-center justify-center gap-1"
                  >
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                          <select
                            ...
                            className="bg-white dark:bg-gray-800 border border-[#CCCCCC] dark:border-gray-600 rounded-lg p-1 text-xs focus:outline-none focus:ring-1 focus:ring-[#ff6d34]"
                          >
                ...
                {tasks[selectedDate] && tasks[selectedDate].length > 0 && (
                  <div className="mt-4 pt-4 border-t border-[#CCCCCC] dark:border-gray-700">
                    <div className="flex justify-between text-sm">
                      <span className="text-[#2D3436]/60">Completed:</span>
